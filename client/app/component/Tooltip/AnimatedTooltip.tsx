...
export const AnimatedTooltip = ({
  ...
  const [itemsToShow, setItemsToShow] = useState<number>(items.length);
  ...
  // Determine how many items to show per breakpoint
  React.useEffect(() => {
    const computeCount = () => {
      if (typeof window === "undefined") return items.length;
    ...
    const apply = () => setItemsToShow(computeCount());
    apply();
